...
export function LandingPage() {
  ...
  return (
    <main className="overflow-x-hidden bg-[#fff8f8] text-[#27171d]">
        ...
        <div className="relative z-10 mx-auto grid max-w-7xl grid-cols-1 items-center gap-20 lg:grid-cols-2">
          <div className="flex flex-col gap-12">
            <div className="flex flex-col gap-3">
              ...
              <p className="mt-3 max-w-xl text-[18px] leading-9 text-[#594048]">
                AITASKER giúp bạn tìm kiếm, thuê và quản lý dự án AI trọn vẹn từ hợp đồng đến thanh toán trên
            ...
            <div className="flex flex-col gap-3 sm:flex-row">
              <LinkButton
                ...
                className="h-11 rounded-lg bg-[#fff0f3] px-6 text-[15px] font-bold text-[#b30069] shadow-sm hover:bg-[#ffe0ea]"
              >
                {primaryLabel}
              ...
              <LinkButton
                ...
                variant="secondary"
                className="h-11 rounded-lg border-[#8d6f79] px-6 text-[15px] font-medium text-[#27171d] hover:bg-[#fff0f3]"
              >
                {secondaryLabel}
            ...
            <div className="flex items-center gap-4 border-t border-[#f8dbe3] pt-7">
              <div className="flex -space-x-2">
                ...
                <Avatar name="Bảo Ngọc" size="sm" className="ring-2 ring-[#fff8f8]" />
              ...
              <p className="text-[18px] text-[#594048]">
                Hơn <span className="font-extrabold text-[#27171d]">5,000+</span> chuyên gia đã tham gia
              </p>
            </div>
          </div>
          ...
          <div className="relative hidden lg:block">
            <div className="rounded-[1.75rem] border border-[#e1bdc8]/30 bg-[rgba(255,240,243,0.7)] p-2 shadow-[0_18px_40px_rgba(61,44,49,.12)] backdrop-blur-[10px]">
              <img src={heroImage} alt="Minh họa cộng tác AI" className="h-[25rem] w-full rounded-[1.25rem] object-cover" />
            </div>
      ...
      <section className="bg-white px-4 py-24 md:px-10">
        <div className="mx-auto max-w-7xl">
          <div className="mx-auto max-w-3xl text-center">
            <h2 className="text-[2.2rem] font-bold text-[#27171d]">Tính năng nổi bật</h2>
            <p className="mt-4 text-[18px] leading-8 text-[#594048]">
              Hệ sinh thái công cụ toàn diện giúp quá trình hợp tác trở nên dễ dàng và an toàn hơn bao giờ hết.
            </p>
          </div>

          <div className="mt-14 grid grid-cols-1 gap-6 md:grid-cols-2 md:auto-rows-[250px]">
            <Card className="rounded-xl border-0 bg-[#fff0f3] p-8 shadow-none transition-colors hover:bg-[#ffe8ee]">
              <div className="mb-4 grid h-12 w-12 place-items-center rounded-lg bg-[#df0e84] text-white">
                <ShieldCheck className="h-5 w-5" />
              </div>
              <h3 className="mb-2 text-[2rem] font-bold text-[#27171d]">Hồ sơ xác minh</h3>
              <p className="text-[15px] leading-7 text-[#594048]">
                100% chuyên gia trên nền tảng đều trải qua quy trình kiểm tra năng lực và danh tính nghiêm ngặt.
              </p>
            </Card>
            ...
            <Card className="rounded-xl border-0 bg-[#fff0f3] p-8 shadow-none transition-colors hover:bg-[#ffe8ee]">
              ...
              <h3 className="mb-2 text-[2rem] font-bold text-[#27171d]">Ví điện tử & Thanh toán</h3>
              <p className="text-[15px] leading-7 text-[#594048]">
                Bảo mật tuyệt đối với hệ thống Escrow. Tiền chỉ được giải ngân khi bạn hài lòng với kết quả nghiệm
                thu.
              </p>
            </Card>
            ...
            <Card className="rounded-xl border-0 bg-[#fff0f3] p-8 shadow-none transition-colors hover:bg-[#ffe8ee]">
              ...
              <h3 className="mb-2 text-[2rem] font-bold text-[#27171d]">Quản lý tiến độ</h3>
              <p className="text-[15px] leading-7 text-[#594048]">
                Chia nhỏ dự án thành các mốc rõ ràng, dễ dàng theo dõi và đánh giá từng giai đoạn.
              </p>
            </Card>
            ...
            <Card className="rounded-xl border-0 bg-[#fff0f3] p-8 shadow-none transition-colors hover:bg-[#ffe8ee]">
              ...
              <h3 className="mb-2 text-[2rem] font-bold text-[#27171d]">Hợp đồng & NDA điện tử</h3>
              <p className="text-[15px] leading-7 text-[#594048]">
      ...
      <section id="how-it-works" className="bg-[#fff8f8] px-4 py-24 md:px-10">
        <div className="mx-auto max-w-7xl">
          <div className="mx-auto max-w-3xl text-center">
            <h2 className="text-[2.2rem] font-bold text-[#27171d]">Cách AITASKER vận hành</h2>
            <p className="mt-4 text-[18px] leading-8 text-[#594048]">
              Quy trình chuyên nghiệp được tinh gọn để tối ưu thời gian cho cả doanh nghiệp và chuyên gia.
            </p>
          </div>

          <div className="mt-16 grid gap-6 lg:grid-cols-5">
            {workflowSteps.map((step, index) => (
              <Card key={step.title} className="rounded-[1.75rem] border border-[#f0dbe3] bg-white p-7 shadow-none">
                <div className="flex h-full flex-col gap-5">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-[#27171d]">{step.title}</h3>
                    <p className="mt-3 text-[15px] leading-7 text-[#594048]">{step.description}</p>
                  </div>
                </div>
              </Card>
            ))}
      ...
      <section className="bg-white px-4 py-24 md:px-10">
        <div className="mx-auto grid max-w-7xl gap-8 lg:grid-cols-2">
          <Card className="rounded-[2rem] border-0 bg-[#fff0f3] p-10 shadow-none">
            <h3 className="text-[2rem] font-bold text-[#27171d]">Dành cho Doanh nghiệp</h3>
            <p className="mt-4 text-[17px] leading-8 text-[#594048]">
              Tăng tốc chuyển đổi số với đội ngũ chuyên gia AI phù hợp, quy trình rõ ràng và hệ thống kiểm soát rủi
              ro minh bạch.
            </p>
            <ul className="mt-8 space-y-4">
              {[
                ...
                <li key={item} className="flex items-start gap-3 text-[15px] leading-7 text-[#27171d]">
            ...
            <LinkButton
              to={experience.primaryPath}
              className="mt-10 h-12 w-full rounded-xl bg-[#b30069] px-6 text-[15px] font-bold text-white hover:bg-[#b8006c]"
            >
              Tôi cần thuê chuyên gia
            </LinkButton>
          </Card>

          <Card className="rounded-[2rem] border border-[#f0dbe3] bg-white p-10 shadow-none">
            <h3 className="text-[2rem] font-bold text-[#27171d]">Dành cho Chuyên gia</h3>
            <p className="mt-4 text-[17px] leading-8 text-[#594048]">
              Làm việc với doanh nghiệp chất lượng, bảo vệ quyền lợi nghề nghiệp và phát triển sự nghiệp AI dài hạn.
            </p>
            <ul className="mt-8 space-y-4">
              {[
            ...
            <LinkButton
              to={experience.secondaryPath}
              variant="secondary"
              className="mt-10 h-12 w-full rounded-xl border-2 border-[#b30069] bg-white px-6 text-[15px] font-bold text-[#b30069] hover:bg-[#fff0f3]"
            >
      ...
      <section className="bg-[#fff8f8] px-4 py-24 md:px-10">
        <div className="mx-auto flex max-w-7xl flex-col gap-16 lg:flex-row lg:items-center">
          <div className="lg:w-1/2">
            <h2 className="text-[2.2rem] font-bold text-[#27171d]">Hợp tác minh bạch & Tin cậy</h2>
            <p className="mt-6 text-[18px] leading-8 text-[#594048]">
              Chúng tôi xây dựng các lớp bảo vệ để đảm bảo mọi dự án đều kết thúc thành công với sự hài lòng từ cả
              hai phía.
            </p>
            ...
            <div className="mt-10 space-y-6">
              {trustHighlights.map((item) => (
                <div key={item.title} className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-lg font-bold text-[#27171d]">{item.title}</h3>
                    <p className="mt-2 text-[15px] leading-7 text-[#594048]">{item.description}</p>
                  </div>
                </div>
              ))}
            </div>
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:w-1/2">
            {trustCards.map((item) => (
              <Card
                key={item.title}
                className={`rounded-[1.75rem] border border-white bg-white p-6 shadow-[0_12px_28px_rgba(61,44,49,.08)] ${
                  item.offset ? 'sm:translate-y-8' : ''
                }`}
              >
                <item.icon className="mb-4 h-8 w-8 text-[#0070ea]" />
                <h3 className="text-lg font-bold text-[#27171d]">{item.title}</h3>
                <p className="mt-2 text-sm leading-6 text-[#594048]">{item.description}</p>
              </Card>
            ))}
          </div>
        </div>
      ...
      <section className="bg-white px-4 py-24 md:px-10">
        <div className="mx-auto max-w-7xl">
          <div className="text-center">
            <h2 className="text-[2.2rem] font-bold text-[#27171d]">Tình huống sử dụng thực tế</h2>
            <p className="mx-auto mt-4 max-w-2xl text-[18px] leading-8 text-[#594048]">
              Khám phá các loại hình dự án AI phổ biến đang được triển khai thành công trên AITASKER.
            </p>
          </div>

          <div className="mt-16 grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {useCases.map((item) => (
              <Card key={item.title} className="rounded-[1.75rem] border border-[#f1e4e8] bg-white p-8 shadow-none">
                <div className="grid h-12 w-12 place-items-center rounded-xl bg-[#fff0f3] text-[#b30069]">
                  <item.icon className="h-5 w-5" />
                </div>
                <h3 className="mt-6 text-[1.3rem] font-bold text-[#27171d]">{item.title}</h3>
                <p className="mt-3 text-[15px] leading-7 text-[#594048]">{item.description}</p>
              </Card>
            ))}

            <Card className="flex rounded-[1.75rem] border-2 border-dashed border-[#e4cad5] bg-[#fff8f8] p-8 shadow-none">
              <div className="flex flex-1 flex-col items-center justify-center text-center">
                <p className="text-[15px] italic leading-7 text-[#594048]">Dự án của bạn đặc thù hơn?</p>
                <LinkButton to="/about" variant="ghost" className="mt-3 h-auto px-0 text-[15px] font-bold text-[#b30069] hover:bg-transparent">
                  Liên hệ tư vấn
                  <ArrowRight className="h-4 w-4" />
                </LinkButton>
              </div>
      ...
      <section className="bg-[#fff8f8] px-4 py-24 md:px-10">
        <div className="mx-auto max-w-3xl">
          <div className="text-center">
            <h2 className="text-[2.2rem] font-bold text-[#27171d]">Câu hỏi thường gặp</h2>
            <p className="mt-4 text-[18px] leading-8 text-[#594048]">Mọi thông tin bạn cần để bắt đầu hành trình cùng AITASKER.</p>
          </div>
          ...
          <div className="mt-16 space-y-4">
            {faqs.map((item, index) => {
              ...
              return (
                <div key={item.question} className="overflow-hidden rounded-2xl border border-[#ead8e0] bg-white">
                  <button
                    type="button"
                    onClick={() => setOpenFaq(isOpen ? null : index)}
                    className="flex w-full items-center justify-between gap-4 px-6 py-5 text-left"
                  >
                    <span className="text-[15px] font-bold text-[#27171d]">{item.question}</span>
                    <ChevronDown className={`h-5 w-5 shrink-0 text-[#8d6f79] transition-transform ${isOpen ? 'rotate-180' : ''}`} />
                  </button>
                  {isOpen ? <p className="px-6 pb-6 text-[15px] leading-7 text-[#594048]">{item.answer}</p> : null}
                </div>
              );
            })}
          </div>
      ...
      <section className="px-4 py-24 md:px-10">
        <div className="relative mx-auto max-w-5xl overflow-hidden rounded-[2rem] bg-[#b30069] px-8 py-14 text-center text-white shadow-[0_28px_60px_rgba(129,19,78,.28)] md:px-12">
          ...
          <div className="relative z-10">
            ...
            <p className="mx-auto mt-6 max-w-2xl text-[18px] leading-8 text-white/90">
              Tham gia cùng hàng nghìn doanh nghiệp đang chuyển đổi số thành công bằng sức mạnh của AI và mạng lưới
              chuyên gia hàng đầu.
            </p>
            ...
            <div className="mt-10 flex flex-col justify-center gap-4 sm:flex-row">
              <LinkButton
                to={experience.primaryPath}
                className="h-12 rounded-xl bg-white px-8 text-[15px] font-bold text-[#b30069] hover:bg-[#fff0f3]"
              >
                Đăng dự án ngay
              </LinkButton>
              <LinkButton
                to={experience.secondaryPath}
                variant="secondary"
                className="h-12 rounded-xl border border-white/40 bg-white/10 px-8 text-[15px] font-bold text-white hover:bg-white/15"
              >
      ...
      <section className="bg-white px-4 pb-24 md:px-10">
        <div className="mx-auto grid max-w-7xl gap-8 rounded-[2rem] border border-[#f0dbe3] bg-[#fff8f8] p-8 lg:grid-cols-[1.2fr_.8fr] lg:p-10">
          <div>
            <h2 className="text-[2rem] font-bold text-[#27171d]">AITASKER dành cho hệ sinh thái AI chuyên nghiệp</h2>
            <p className="mt-4 text-[17px] leading-8 text-[#594048]">
              Từ startup đang thử nghiệm MVP đến doanh nghiệp cần chuẩn hóa quy trình AI, AITASKER tạo ra một nơi
              làm việc đủ nhanh, đủ an toàn và đủ minh bạch để hợp tác lâu dài.
            </p>
          </div>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="rounded-2xl bg-white p-5">
              ...
              <p className="mt-3 text-sm font-bold text-[#27171d]">Mạng lưới toàn cầu</p>
              <p className="mt-1 text-sm leading-6 text-[#594048]">Kết nối với chuyên gia AI ở nhiều thị trường và lĩnh vực.</p>
            </div>
            <div className="rounded-2xl bg-white p-5">
              <ShieldCheck className="h-6 w-6 text-[#b30069]" />
              <p className="mt-3 text-sm font-bold text-[#27171d]">Vận hành an toàn</p>
              <p className="mt-1 text-sm leading-6 text-[#594048]">Quy trình có Escrow, NDA và đánh giá hai chiều rõ ràng.</p>
            </div>
          </div>
        </div>
      </section>

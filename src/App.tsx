  ...
  return (
    <main className="grid min-h-screen place-items-center bg-[#f7faff] px-4">
      <Card className="max-w-lg p-8 text-center">
        ...
        <h1 className="mt-4 font-display text-2xl font-black text-ink">Không tìm thấy giao diện</h1>
        <p className="mt-2 text-sm leading-6 text-slate-500">
          Route này chưa được định nghĩa. Tất cả màn hình chính đều có trong navigation theo role.
        </p>
        <div className="mt-6">
